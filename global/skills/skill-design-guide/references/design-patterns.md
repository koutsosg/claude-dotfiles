...
- **Problem-first:** "I need to set up a project workspace" — the skill orchestrates the right tools in the right sequence. Users describe outcomes; the skill handles the tools.
...
- Dependencies between steps (Step 3 uses output from Step 1)
...
- Clear governance and decision trails
